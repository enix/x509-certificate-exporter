...
A Prometheus exporter for certificates focusing on expiration monitoring, written in Go. It was designed to run in Kubernetes clusters but can also be used in standalone mode.
